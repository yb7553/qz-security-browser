 ...
 * 
 */
package com.qz.security.browser.logout;
 ...
 *
 */
public class QzLogoutSuccessHandler implements LogoutSuccessHandler {

	private Logger logger = LoggerFactory.getLogger(getClass());

	public QzLogoutSuccessHandler(String signOutSuccessUrl) {
